<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="dki.ascx.cs" Inherits="webs_banlaptop.login.dki" %>
<div class="align-content-center">
    ...
    &nbsp;<span class="border border-dark">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <asp:TextBox ID="TextBox1" runat="server" BorderColor="Blue" BorderStyle="Ridge" Width="333px"></asp:TextBox></span>
    <br />
    <asp:Label ID="Label2" ForeColor="YellowGreen" runat="server" Text="Nhập Lại Mật Khẩu:"></asp:Label>
