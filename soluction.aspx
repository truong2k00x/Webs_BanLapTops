<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="soluction.aspx.cs" Inherits="webs_banlaptop.soluction" %>
...
<body style="background-image: url(img/_nuxt/background/28.jpg); background-size: cover; height: 100%; margin: 0;" data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="50">
    <form id="form1" runat="server">
        <header resource="false" style="position: sticky; z-index: 4; top: 0; left: 0; width: 100%;" class="container header-main">
            <%-- <div class="container">--%>
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent,#navr,#navr1" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <div class="dropdown">
                                <p class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-target="accer" data-toggle="dropdown">
                                    Danh mục
                                </p>
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item">
                                        <asp:TextBox ID="txt1x" Width="1px" Height="1px" runat="server" Visible="True" OnDisposed="TextBox1_TextChanged" OnDataBinding="TextBox1_TextChanged" OnInit="TextBox1_TextChanged" OnLoad="TextBox1_TextChanged" OnPreRender="TextBox1_TextChanged" OnTextChanged="TextBox1_TextChanged" OnUnload="TextBox1_TextChanged" CausesValidation="True" EnableTheming="True"></asp:TextBox></a>
                                </div>
                            </div>
                        </li>
                        <%--<li class="nav-item">
                ...
                <asp:Label ID="lblsr" Text="" runat="server"></asp:Label>
                ...
                <a href="soluction.aspx?uc=gh">
                    ...
                    <asp:Literal ID="shopcardlt" runat="server"></asp:Literal>
                </a>
        ...
        <div class="container">
            ...
            <div class="row" style="font-size: 18px; color: black; background-color: #ccccff">
                <asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>
            </div>
        </div>
        <footer style="margin-top:20px" class="container footerButton">
            <div style="background-color: white" class="">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <p class="font-black text-h1">Tự tin mua sắm cùng ThinkPro</p>
                        <div class="row">
                    ...
                    <div class="col-md-3">
                        <ul class="container list-unstyled" style="color: black">
                            <a style="font-size=20px;">CHÍNH SÁCH THINKPRO</a>
        ...
        <div>
            ...
            <div dir="ltr" data-b24-crm-button-cont="" class="b24-widget-button-wrapper b24-widget-button-position-bottom-right b24-widget-button-visible" id="sudovn-btn-wrapper">
                ...
                <div id="sudovn-btn-social">
                    <a href="tel:0981086913" target="_blank" rel="nofollow" class="sudovn-btn-social-item">
                        ...
                        <div data-b24-crm-button-block-inner="" class="b24-widget-button-inner-block" style="background: #00aeef">
                            ...
                            <div class="b24-widget-button-inner-item b24-widget-button-close" id="sudovn-btn-close">
                                <svg class="b24-widget-button-icon b24-widget-button-close-item" xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29">
                                    <path fill="#FFF" fill-rule="evenodd" d="M18.866 14.45l9.58-9.582L24.03.448l-9.587 9.58L4.873.447.455 4.866l9.575 9.587-9.583 9.57 4.418 4.42 9.58-9.577 9.58 9.58 4.42-4.42"></path></svg>
                            </div>
                        </div>
                    </div>
                </div>
